...
[![Tests: 106 passing](https://img.shields.io/badge/Tests-106%20passing-brightgreen?style=flat)](tests/app.test.js)
...
- **106 unit tests** — a dependency-free test runner covers the core logic (run `node tests/app.test.js`)
...
- `updateFilterBar` — filter bar visibility based on todo count (4 tests)
...
├── tests/
│   └── app.test.js         # Dependency-free unit test suite (106 tests)
├── discussion/
