...
[![Tests: 98 passing](https://img.shields.io/badge/Tests-98%20passing-brightgreen?style=flat)](tests/app.test.js)
...
- **100% unit tested** — a dependency-free test runner covers the core logic (run `node tests/app.test.js`)
